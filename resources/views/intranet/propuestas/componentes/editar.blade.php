...
@section('titulo_card')
    <i class="fa fa-edit mr-3" aria-hidden="true"></i> Editar Propuestas Componentes
@endsection
...
@section('cuerpo')
    <div class="row d-flex justify-content-center" style="font-size: 0.85em">
        <form class="col-12 form-horizontal" action="{{ route('subcomponentes.update', ['id' => $subcomponente_edit->id]) }}" method="POST"
