...
@section('titulo_card')
    <i class="fa fa-edit mr-3" aria-hidden="true"></i> Editar Categorías/Componentes
@endsection
...
@section('cuerpo')
    <div class="row d-flex justify-content-center" style="font-size: 0.85em">
        <form class="col-12 form-horizontal" action="{{ route('componentes.update', ['id' => $componente_edit->id]) }}" method="POST"
