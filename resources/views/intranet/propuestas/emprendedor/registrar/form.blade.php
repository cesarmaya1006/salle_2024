    ...
    <div class="col-12 col-md-7">
        <div class="form-group">
            ...
            <select class="form-control form-control-sm" name="sector" id="sector" required>
                ...
                <option value="Comercio al por menor en establecimientos">Comercio al por menor en establecimientos</option>
                <option value="Comercio al por menor de computadores, equipos periféricos, programas de informática y equipos de telecomunicaciones">Comercio al por menor de computadores, equipos periféricos, programas de informática y equipos de telecomunicaciones</option>
                <option value="Comercio al por menor de libros, periódicos, materiales y artículos de papelería y escritorio">Comercio al por menor de libros, periódicos, materiales y artículos de papelería y escritorio</option>
                <option value="Productos y servicios alimenticios ">Productos y servicios alimenticios </option>
                <option value="Información y comunicaciones actividades inmobiliarias">Información y comunicaciones actividades inmobiliarias</option>
                ...
                <option value="Actividades artísticas, de entretenimiento y recreación y otras actividades de servicios">Actividades artísticas, de entretenimiento y recreación y otras actividades de servicios</option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-sm" name="sustentacion[]" id="sustentacion_{{$sub_componente->id}}" cols="30" rows="5"data_name_simp="{{$sub_componente->sub_componente}}" data_name="Sustentacion {{$sub_componente->sub_componente}}" required>Es un hecho establecido hace demasiado tiempo que un lector se distraerá con el contenido del texto</textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            @else
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="requerido" for="canvas">Subir Canvas</label>
                                            <input type="file" class="form-control form-control-sm" name="canvas" id="canvas_{{$sub_componente->id}}" aria-describedby="helpId" accept="application/pdf" required>
                                            <small id="helpId" class="form-text text-muted">Archivo en PDF unicamente</small>
                                        </div>
                                    </div>
                                </div>
                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="requerido" for="video">Subir url video</label>
                                                <input type="text" class="form-control form-control-sm" name="video" id="video_{{$sub_componente->id}}" aria-describedby="helpId" required>
