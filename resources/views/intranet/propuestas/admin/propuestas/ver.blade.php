...
@section('titulo_pagina')
    <i class="fas fa-folder-open mr-3" aria-hidden="true"></i> CONVOCATORIA Nª 01 DE 2022 DEL FONDO DE EMPRENDIMIENTO DE FUNZA – FEMF
@endsection

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
<li class="breadcrumb-item"><a href="{{ route('propuestas.index') }}">Propuestas</a></li>
<li class="breadcrumb-item active">Ver Propuesta - {{$propuesta->codigo}}</li>
@endsection
...
@section('titulo_card')
    ...
    <strong>Codigo:</strong>{{$propuesta->codigo}}
@endsection
    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-md-center">
            <div class="col-12 table-responsive">
                <table class="table table-striped table-hover table-sm tabla_data_table_m tabla-borrando">
                    <thead>
                        <tr>
                            <th></th>
